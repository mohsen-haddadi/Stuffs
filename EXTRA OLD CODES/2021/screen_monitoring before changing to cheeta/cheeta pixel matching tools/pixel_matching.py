...
def pre_flop_pixel(game_position): #NO NEED
...
def river_pixel(game_position):
    ...
    return river 
#2020
def small_blind_pixel(game_position, seat): #NO NEED
...
#2020
def big_blind_pixel(game_position, seat): #NO NEED
...
def i_am_seated_pixel(game_position, seat): #NO NEED YET
...
#2020
def my_seat_won_pixel(game_position, seat): #NO NEED YET
...
def notification_banner_pixel(game_position, seat): # celeb #NO NEED
...
def are_chips_white_or_red_pixel(game_position, seat): #celeb  #NO NEED
    """
...
def button_pixel(game_position, button_name): #NO NEED
